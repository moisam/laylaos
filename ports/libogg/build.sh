...
#
# Script to download and build libogg
#

DOWNLOAD_NAME="libogg"
DOWNLOAD_VERSION="1.3.5"
DOWNLOAD_URL="https://ftp.osuosl.org/pub/xiph/releases/ogg/"
DOWNLOAD_PREFIX="libogg-"
...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/lib/libogg.so
