...
#
# Script to download and build libidn
#

DOWNLOAD_NAME="libidn"
DOWNLOAD_VERSION="1.42"
DOWNLOAD_URL="https://ftp.gnu.org/gnu/libidn/"
DOWNLOAD_PREFIX="libidn-"
...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/lib/libidn.so
...
mv ${DOWNLOAD_SRCDIR}/lib/m4/libtool.m4 ${DOWNLOAD_SRCDIR}/lib/m4/libtool.m4.OLD
cp ${CWD}/../libtool.m4.laylaos ${DOWNLOAD_SRCDIR}/lib/m4/libtool.m4
