...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/bin/gzip
...
../configure --host=${BUILD_TARGET} || exit_failure "$0: failed to configure ${DOWNLOAD_NAME}"
