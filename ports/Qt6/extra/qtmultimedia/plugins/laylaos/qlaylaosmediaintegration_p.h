...
#ifndef QLaylaOSMediaIntegration_H
#define QLaylaOSMediaIntegration_H
...
class QLaylaOSFormatInfo;

class QLaylaOSMediaIntegration : public QPlatformMediaIntegration
{
public:
    QLaylaOSMediaIntegration();
