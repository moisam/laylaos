...
#
# Script to download and build tar
#

DOWNLOAD_NAME="tar"
DOWNLOAD_VERSION="1.35"
DOWNLOAD_URL="https://ftp.gnu.org/gnu/tar/"
DOWNLOAD_PREFIX="tar-"
...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/bin/tar
...
LDFLAGS="-liconv" ../configure FORCE_UNSAFE_CONFIGURE=1 \
