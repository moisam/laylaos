...
set(CMAKE_C_FLAGS "-I${crosscompile_sysroot}/usr/include -I${crosscompile_sysroot}/usr/include/freetype2 -I${crosscompile_sysroot}/usr/include/freetype2/freetype --sysroot=${crosscompile_sysroot} -D__laylaos__ -D__${crosscompile_arch}__ -D_GNU_SOURCE")
set(CMAKE_CXX_FLAGS "-I${crosscompile_sysroot}/usr/include -I${crosscompile_sysroot}/usr/include/freetype2 -I${crosscompile_sysroot}/usr/include/freetype2/freetype --sysroot=${crosscompile_sysroot} -D__laylaos__ -D__${crosscompile_arch}__ -D_GNU_SOURCE")
