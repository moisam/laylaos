...
#
# Script to download and build sed
#

DOWNLOAD_NAME="sed"
DOWNLOAD_VERSION="4.9"
DOWNLOAD_URL="https://ftp.gnu.org/gnu/sed/"
DOWNLOAD_PREFIX="sed-"
...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/bin/sed
