...
#
# Script to download and build cpio
#

DOWNLOAD_NAME="cpio"
DOWNLOAD_VERSION="2.15"
DOWNLOAD_URL="https://ftp.gnu.org/gnu/cpio/"
DOWNLOAD_PREFIX="cpio-"
...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/bin/mt
