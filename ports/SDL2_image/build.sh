...
#
# Script to download and build SDL2_image
#

DOWNLOAD_NAME="SDL2_image"
DOWNLOAD_VERSION="2.8.2"
DOWNLOAD_URL="https://github.com/libsdl-org/SDL_image/releases/download/release-${DOWNLOAD_VERSION}/"
DOWNLOAD_PREFIX="SDL2_image-"
...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/lib/libSDL2_image.so
