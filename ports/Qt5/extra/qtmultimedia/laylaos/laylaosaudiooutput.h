...
class LaylaOSAudioOutput : public QAbstractAudioOutput
{
    Q_OBJECT
...
private:
    ...
    friend class LaylaOSPushIODevice;
...
class LaylaOSPushIODevice : public QIODevice
{
    Q_OBJECT
public:
    explicit LaylaOSPushIODevice(LaylaOSAudioOutput *output);
    ~LaylaOSPushIODevice();
