...
#
# Script to download and build GnuDOS
#

DOWNLOAD_NAME="gnudos"
DOWNLOAD_URL="https://github.com/moisam/gnudos-mirror.git"
PATCH_FILE=${DOWNLOAD_NAME}.diff
CWD=`pwd`

# where the downloaded and extracted source will end up
DOWNLOAD_SRCDIR="${DOWNLOAD_PORTS_PATH}/gnudos-mirror"

# get common funcs
source ../common.sh

# check for an existing compile
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/lib/libgnudos.so
