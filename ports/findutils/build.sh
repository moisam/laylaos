...
#
# Script to download and build findutils
#

DOWNLOAD_NAME="findutils"
DOWNLOAD_VERSION="4.10.0"
DOWNLOAD_URL="https://ftp.gnu.org/gnu/findutils/"
DOWNLOAD_PREFIX="findutils-"
...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/bin/find
