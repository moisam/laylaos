...
#
# Script to download and build gst-libav
#

DOWNLOAD_NAME="gst-libav"
DOWNLOAD_VERSION="1.20.7"
DOWNLOAD_URL="https://gstreamer.freedesktop.org/src/gst-libav/"
DOWNLOAD_PREFIX="gst-libav-"
...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/lib/gstreamer-1.0/libgstlibav.so
...
meson setup build --cross-file ${CWD}/../crossfile.meson.laylaos \
    --buildtype=release \
    -D doc=disabled -D tests=enabled \
