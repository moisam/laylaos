...
#
# Script to download and build libffi
#

DOWNLOAD_NAME="libffi"
DOWNLOAD_VERSION="3.4.4"
DOWNLOAD_URL="https://github.com/libffi/libffi/releases/download/v${DOWNLOAD_VERSION}/"
DOWNLOAD_PREFIX="libffi-"
...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/lib/libffi.so
