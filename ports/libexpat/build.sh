...
#
# Script to download and build libexpat
#

DOWNLOAD_NAME="libexpat"
DOWNLOAD_VERSION="2.5.0"
DOWNLOAD_VERSION__="2_5_0"
DOWNLOAD_URL="https://github.com/libexpat/libexpat/releases/download/R_${DOWNLOAD_VERSION__}/"
DOWNLOAD_PREFIX="expat-"
...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/lib/libexpat.so
...
cd ${DOWNLOAD_SRCDIR} && ./buildconf.sh && cd ${CWD}
