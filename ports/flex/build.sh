...
#
# Script to download and build flex
#

DOWNLOAD_NAME="flex"
DOWNLOAD_VERSION="2.6.4"
DOWNLOAD_URL="https://github.com/westes/flex/files/981163/"
DOWNLOAD_PREFIX="flex-"
...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/bin/flex
...
LDFLAGS="-L${CROSSCOMPILE_SYSROOT_PATH}/usr/lib" CFLAGS="$CFLAGS -mstackrealign" \
    ../configure \
