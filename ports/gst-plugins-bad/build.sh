...
#
# Script to download and build gst-plugins-bad
#

DOWNLOAD_NAME="gst-plugins-bad"
DOWNLOAD_VERSION="1.20.7"
DOWNLOAD_URL="https://gstreamer.freedesktop.org/src/gst-plugins-bad/"
DOWNLOAD_PREFIX="gst-plugins-bad-"
...
check_existing ${DOWNLOAD_NAME} ${CROSSCOMPILE_SYSROOT_PATH}/usr/lib/gstreamer-1.0/libgstaiff.so
