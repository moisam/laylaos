...
set(CMAKE_STAGING_PREFIX ${crosscompile_sysroot}/usr/local)
set(CMAKE_PREFIX_PATH ${crosscompile_sysroot}:${crosscompile_sysroot}/usr:${crosscompile_sysroot}/usr/local)
...
set(CMAKE_C_FLAGS "-I${crosscompile_sysroot}/usr/local/include -I${crosscompile_sysroot}/usr/include/freetype2 -I${crosscompile_sysroot}/usr/include/freetype2/freetype --sysroot=${crosscompile_sysroot} -D__laylaos__ -D__${crosscompile_arch}__ -D_GNU_SOURCE -mstackrealign")
set(CMAKE_CXX_FLAGS "-I${crosscompile_sysroot}/usr/local/include -I${crosscompile_sysroot}/usr/include/freetype2 -I${crosscompile_sysroot}/usr/include/freetype2/freetype --sysroot=${crosscompile_sysroot} -D__laylaos__ -D__${crosscompile_arch}__ -D_GNU_SOURCE -mstackrealign")

set(CMAKE_FIND_ROOT_PATH ${crosscompile_sysroot})
list(APPEND CMAKE_FIND_ROOT_PATH ${crosscompile_sysroot}/usr)
list(APPEND CMAKE_FIND_ROOT_PATH ${crosscompile_sysroot}/usr/Qt-6.11)
...
#set(OPENGL_USE_OPENGL True)
set(QT_HOST_PATH ${crosscompile_sysroot}/usr/Qt-6.11)
set(OPENGL_INCLUDE_DIR ${crosscompile_sysroot}/usr/include)
set(OPENGL_gl_LIBRARY ${crosscompile_sysroot}/usr/lib/libGL.so)
set(OPENGL_egl_LIBRARY ${crosscompile_sysroot}/usr/lib/libEGL.so)
